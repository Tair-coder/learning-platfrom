...
export function Button({
  ...
  const variants = {
    primary:
      'bg-card text-foreground border-2 border-foreground rounded-xl hover:bg-muted shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px]',
    secondary:
      'bg-muted text-foreground border-2 border-transparent rounded-xl hover:bg-muted/80',
